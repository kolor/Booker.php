...
class Application_Model_Client_Details extends Application_Model_Base {
    ...
    {
        $sql = self::getDb()->select()->from('details')->where('row_id = ?', $user)->where('row_type = 2');
    ...
    public function save()
    {
        ...
        if ($this->id === null) {
            ...
            $this->getDb()->update('details', $data, array('id = ?' => $this->id, 'row_type = 2'));
        }
    }
